...
import 'package:smartkit_pro/ui/fullApps/DoctorApp/helper/src/utils/calender_utils.dart';
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        Text(
                          ...
                          style: TextStyle(
                              color: diffDays != 0
                                  ? widget.colorOfWeek ?? ColorRes.blue
                                  : Colors.white,
                        ...
                        Text(
                          ...
                          style: TextStyle(
                            color: diffDays != 0
                                ? widget.colorOfMonth ?? ColorRes.blue
                                : Colors.white,
          ...
          Container(
            ...
            child: InkWell(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                    color: widget.tableCalenderButtonColor ?? ColorRes.blue,
        ...
        return Theme(
          data: widget.tableCalenderThemeData ??
              ThemeData.light().copyWith(
                ...
                hintColor: ColorRes.black,
                colorScheme: ColorScheme.light(primary: ColorRes.black),
                buttonTheme:
